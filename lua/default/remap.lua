...
vim.keymap.set("n", "<C-l>", "<cmd>cprev<CR>", { desc = "Go to previous item in quickfix list" })
vim.keymap.set("n", "<C-h>", "<cmd>cnext<CR>", { desc = "Go to next item in quickfix list" })
vim.keymap.set("n", "<A-l>", "<cmd>lnext<CR>zz")
vim.keymap.set("n", "<A-h>", "<cmd>lprev<CR>zz")
